# Laravel 5.5 Lumen 5.5 Github Code API
...
```
Step1. cd /var/www
git clone -b master https://github.com/sirinibin/codeapi.git codeapi
...
Step3. Point API end point URL to /var/www/codeapi/public

      eg: http://codeapi.dockerboxes.us
